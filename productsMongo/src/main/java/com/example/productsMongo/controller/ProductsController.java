...
//@PathVariable ("id") String id
  ...
  @PostMapping (value = "/updateStock")
    ...
    public ResponseEntity<ListOfProductEntities> MerchnatByProductName (@PathVariable("merchantId") String merchantId , @PathVariable("productName") String productName)
    {
    ...
    public ResponseEntity<Integer> getRating (@PathVariable("productId") String productId,@PathVariable("currentRatingNew") Integer currentRatingNew)
    {
